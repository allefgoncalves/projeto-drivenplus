...
import User_ID_DO_PLANO_Update from './componets/pages/UserPlanoUpdatePage/UserPlanoUpdatePage';
      ...
      <UseContext.Provider value={{token, setToken}}> 
        <BrowserRouter>
          <Routes>
            ...
            <Route path={`/teste`} element={<Subscriptions_ID_DO_PLANO />}></Route> {/*//copia para teste*/}
